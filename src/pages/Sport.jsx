...
const Sport = () => {
  ...
  const getSportNews = async () => {
    ...
    https://newsapi.org/v2/top-headlines?country=ng&category=sports&apiKey=${myApiKey}`);
